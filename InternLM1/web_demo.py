...
def load_model():
    model = (
        AutoModelForCausalLM.from_pretrained("/home/xlab-app-center", trust_remote_code=True)
        .to(torch.bfloat16)
        .cuda()
    )
    tokenizer = AutoTokenizer.from_pretrained("/home/xlab-app-center", trust_remote_code=True)
